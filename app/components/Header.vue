...
<template>
    <header class="site-header">
        <NuxtLink to="/" class="logo" @click="closeMenus"> KZU Trade </NuxtLink>
        ...
        <div :class="['header-content', { open: menuOpen }]">
            <nav class="nav">
                <NuxtLink to="/" @click="closeMenus"> Home </NuxtLink>

                <NuxtLink to="/#gallery" @click="closeMenus">
                    Galerie
                </NuxtLink>

                <NuxtLink to="/about" @click="closeMenus"> Über uns </NuxtLink>
